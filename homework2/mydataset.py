...
def download_and_extract_qm9(save_filepath):
    ...
    download_file_path = './dsgdb9nsd.xyz.tar.bz2'
...
if __name__ == "__main__":
    f,s = get_qm9(GGNNPreprocessor(kekulize=True), return_smiles=True,
                                           target_index=numpy.random.choice(range(133000), 100, False))
    # print(f)
    print('done')